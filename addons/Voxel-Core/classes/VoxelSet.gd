...
# Library of voxels used by a VoxelObject.



## Declarations
# Emitted when VoxelSet has had a request_refresh called
...
# Flag indicating whether UVScale, TileSize and Tiles texture is set
var UVReady := false setget set_uv_ready
# Prevent external modifications to UV Ready
...
# Prevent external modifications to UV Scale
