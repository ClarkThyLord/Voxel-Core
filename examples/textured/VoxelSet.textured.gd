...
func _load():
	...
	set_voxel(Voxel.textured(Vector2(3, 0), Color.white, {'name': 'dirt grass'}))
	...
	# TODO fix textured constructure to be able  to define sides on construct
	set_voxel(Voxel.textured(Vector2(2, 3), Color.white, {'name': 'tnt'}))
#	set_voxel(Voxel.textured(Vector2(3, 3), Color.white, {'name': ''}))
#	set_voxel(Voxel.textured(Vector2(4, 3), Color.white, {'name': ''}))
